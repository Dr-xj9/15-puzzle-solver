...
def main():
    ...
    while True: # main game loop
        msg = 'Animación 15 Puzzle con A star' # contains the message to show in the upper left corner.
...
def resolver():
    with open('Solucion_Astar.txt', 'r') as archivo:
        contenido = archivo.read().splitlines()
    print(contenido)
    return contenido

def generarPuzzle():
    # Genera el puzzle en una forma para posteriormente mostrar el recorrido de solución
    board = [[1, 5, 9, 13], [2, 6, 10, 14], [BLANK, 7, 11, 3], [4, 8, 12, 15]]
    return board
